...
if(POLYSOLVE_WITH_CHOLMOD)
    ...
    if(CHOLMOD_FOUND)
        ...
        if(SUITESPARSE_FOUND)
            target_link_libraries(polysolve PUBLIC ${SUITESPARSE_LIBRARIES})
            target_include_directories(polysolve PUBLIC ${SUITESPARSE_INCLUDE_DIRS})
            target_compile_definitions(polysolve PUBLIC -DPOLYSOLVE_WITH_CHOLMOD)
        endif()
    endif()
endif()
...
if(POLYSOLVE_WITH_MKL)
    ...
    if(MKL_FOUND)
        ...
        SET(POLYSOLVE_HAS_PARDISO ON)
    else()
        MESSAGE(WARNING "unable to find MKL")
        SET(POLYSOLVE_HAS_PARDISO OFF)
    endif()
endif()
...
if(POLYSOLVE_WITH_AMGCL)
    ...
    if(Boost_FOUND)
        ...
        SET(POLYSOLVE_HAS_AMGCL ON)
    else()
        MESSAGE(WARNING "Boost not found, AMGCL requires boost thus it has been disabled")
        SET(POLYSOLVE_HAS_AMGCL OFF)
    endif()
endif()
