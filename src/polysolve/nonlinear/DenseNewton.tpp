...
namespace polysolve::nonlinear
{
    ...
    DenseNewton<ProblemType>::DenseNewton(
    ...
    template <typename ProblemType>
    std::string DenseNewton<ProblemType>::descent_strategy_name(int descent_strategy) const
    {
    ...
    template <typename ProblemType>
    void DenseNewton<ProblemType>::increase_descent_strategy()
    {
    ...
    template <typename ProblemType>
    void DenseNewton<ProblemType>::reset(const int ndof)
    {
    ...
    template <typename ProblemType>
    bool DenseNewton<ProblemType>::compute_update_direction(
        ProblemType &objFunc,
        const TVector &x,
        const TVector &grad,
        TVector &direction)
    ...
    template <typename ProblemType>
    void DenseNewton<ProblemType>::assemble_hessian(
    ...
    template <typename ProblemType>
    bool DenseNewton<ProblemType>::solve_linear_system(
    ...
    template <typename ProblemType>
    bool DenseNewton<ProblemType>::check_direction(
    ...
    template <typename ProblemType>
    void DenseNewton<ProblemType>::update_solver_info(const double energy)
    {
