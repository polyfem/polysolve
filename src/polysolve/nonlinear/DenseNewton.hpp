...
namespace polysolve::nonlinear
{
    ...
    class DenseNewton : public NonlinearSolver<ProblemType>
    {
    public:
        ...
        DenseNewton(const json &solver_params, const json &linear_solver_params, const double dt);
