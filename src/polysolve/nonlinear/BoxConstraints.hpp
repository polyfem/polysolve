...
namespace polysolve::nonlinear
{
    ...
    class BoxConstraints : public NonlinearSolver<ProblemType>
    {
    public:
        ...
        BoxConstraints(const polyfem::json &solver_params, const double dt, const double characteristic_length)
